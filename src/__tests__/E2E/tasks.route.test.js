...
describe('GET /api/tasks', () => {
    ...
    it('Should return array of tasks', async () => {
        ...
        expect(response.body[0]).toHaveProperty('desc', 'Task One')
        expect(response.body[0]).toHaveProperty('status', false)
        expect(response.body[0]).toHaveProperty('createdAt')
        expect(response.body[1]).toHaveProperty('desc', 'Task Two')
        expect(response.body[1]).toHaveProperty('status', true)
